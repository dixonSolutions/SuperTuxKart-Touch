...
export APP_NAME_RELEASE="${APP_NAME_RELEASE:-SuperTuxKart}"
export PACKAGE_NAME_RELEASE="${PACKAGE_NAME_RELEASE:-org.supertuxkart.stk}"
export PACKAGE_CLASS_NAME_RELEASE="${PACKAGE_CLASS_NAME_RELEASE:-org/supertuxkart/stk}"
export APP_DIR_NAME_RELEASE="${APP_DIR_NAME_RELEASE:-supertuxkart}"
export APP_ICON_RELEASE="${APP_ICON_RELEASE:-$DIRNAME/icon.png}"
export APP_ICON_ADAPTIVE_BG_RELEASE="${APP_ICON_ADAPTIVE_BG_RELEASE:-$DIRNAME/icon_adaptive_bg.png}"
export APP_ICON_ADAPTIVE_FG_RELEASE="${APP_ICON_ADAPTIVE_FG_RELEASE:-$DIRNAME/icon_adaptive_fg.png}"

export APP_NAME_BETA="${APP_NAME_BETA:-SuperTuxKart Beta}"
export PACKAGE_NAME_BETA="${PACKAGE_NAME_BETA:-org.supertuxkart.stk_beta}"
export PACKAGE_CLASS_NAME_BETA="${PACKAGE_CLASS_NAME_BETA:-org/supertuxkart/stk_beta}"
export APP_DIR_NAME_BETA="${APP_DIR_NAME_BETA:-supertuxkart-beta}"
export APP_ICON_BETA="${APP_ICON_BETA:-$DIRNAME/icon-dbg.png}"
export APP_ICON_ADAPTIVE_BG_BETA="${APP_ICON_ADAPTIVE_BG_BETA:-$DIRNAME/icon_adaptive_bg-dbg.png}"
export APP_ICON_ADAPTIVE_FG_BETA="${APP_ICON_ADAPTIVE_FG_BETA:-$DIRNAME/icon_adaptive_fg-dbg.png}"

export APP_NAME_DEBUG="${APP_NAME_DEBUG:-SuperTuxKart Debug}"
export PACKAGE_NAME_DEBUG="${PACKAGE_NAME_DEBUG:-org.supertuxkart.stk_dbg}"
export PACKAGE_CLASS_NAME_DEBUG="${PACKAGE_CLASS_NAME_DEBUG:-org/supertuxkart/stk_dbg}"
export APP_DIR_NAME_DEBUG="${APP_DIR_NAME_DEBUG:-supertuxkart-dbg}"
export APP_ICON_DEBUG="${APP_ICON_DEBUG:-$DIRNAME/icon-dbg.png}"
export APP_ICON_ADAPTIVE_BG_DEBUG="${APP_ICON_ADAPTIVE_BG_DEBUG:-$DIRNAME/icon_adaptive_bg-dbg.png}"
export APP_ICON_ADAPTIVE_FG_DEBUG="${APP_ICON_ADAPTIVE_FG_DEBUG:-$DIRNAME/icon_adaptive_fg-dbg.png}"
